$(function(){
	$('.download').click(function(){window.open('http://au2.gameflier.com/download/program.aspx');      });
	$('.account').click(function(){window.open('https://gfb.gameflier.com/Billing/account/AU2/index2.asp?SourceID=2&Game=AU2');      });
	$('.Billing').click(function(){window.open('https://gfb.gameflier.com/Billing/Login/login.asp?redct=G12&game=AUII');      });
	$('#fans').click(function(){window.open('https://www.facebook.com/GF.Audition2?fref=ts');      });
  });
