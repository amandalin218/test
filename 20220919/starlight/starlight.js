...
var user_configuration={
	...
	colors:["hsla(62, 50%,100%, 0.5)", "rgba(255,255,255,0.5)","hsla(180, 72%, 100%, 0.5)"], //The variety of colors of the stars. Can be any CSS complient color (eg. HEX, rgba, hsl)
	frequency:400, //how often a new wave of stars pop-out (in milliseconds. Bigger==longer)
